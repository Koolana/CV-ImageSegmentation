...
Таким образом в результате прохода FPN модели на выходе последнего слоя top-down pathway получаем семантическую карту входного изображения. Пример входного изображения и изображения с целевой разметкой представлен на рисунке ниже.
...
Накладываем целевую и результирующую сегментацию на входное изображение. Здесь представлены изображения метки (слева) и полученные нами результаты (справа).
