...
Таким образом в результате прохода FPN модели на выходе последнего слоя top-down pathway получаем семантическую карту входного изображения. Пример целевого изображения с итоговым выходом обученной модели представлен ниже.
...
Накладываем целевую и результирующую сегментацию на входное изображение:
